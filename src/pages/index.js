        ...
        <div className="col-span-6 hidden lg:flex  ">
          <div className="flex gap-6 items-start">
            <div className="space-y-6 mt-[152px]">
              ...
              <Image src={image2} width="220" alt="image" />
              <Image src={image3} width="220" alt="image" />
            </div>
            <div className="space-y-6 mt-20">
              <Image src={image4} priority width="220" alt="image" />
              <Image src={image5} priority width="220" alt="image" />
              <Image src={image6} width="220" alt="image" />
            </div>
            <div className="space-y-6 -mt-[100px]">
              <Image src={image7} width="220" alt="image" />
              <Image src={image8} width="220" alt="image" />
              <Image src={image9} width="220" alt="image" />
            </div>
          </div>
        </div>
      </div>
